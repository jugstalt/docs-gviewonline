...
.. note::
   Als die erste Version von *gView GIS* entwickelt wurde, waren noch offene GeoDatenbank wie PostGIS noch 
   ...
   Es wird empfohlen, als Datenquelle für die Kartendienste PostGIS oder SQL Server zu verwenden, die diese auch
...
Die einzige Relevanz hat die *gView Feature Database* noch, um eine Offline GIS bereitzustellen. Dazu werden die Daten einer 
gView Karte in eine *gView SQLite Feature Database* gespeichert. Diese kann dann "offline" mitgenommen werden.
Ein Kompatibilität mit anderen GIS Software Paketen ist hier in der Regel nicht vorrangig.
