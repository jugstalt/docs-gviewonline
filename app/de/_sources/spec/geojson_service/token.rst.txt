...
Der Response enthält das erzeugte Token und die zugehörigen Metadaten.  
...
.. note::  
   ...
   Der ``access_token`` ist allen Requests im ``HTTP Header Authorize`` als **Bearer Token** zu übergeben:  
